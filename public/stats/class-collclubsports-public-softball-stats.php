 ...
 */
class CollClubSports_Public_Softball_Stats {
	...
	private function register_shortcodes() {
		add_shortcode('softball-stats', array($this, 'stats'));
		add_shortcode('softball-game-stats', array($this, 'gamestats'));
	}
	...
	public function gamestats($attrs) {
		$gameid = $attrs['game'];
		$gamestats = $this->api->getSoftballStatsPerGame($gameid);
